                ...
                <tbody>
                    <c:forEach var="user" items="${Etudiant}">
                        ...
                        <tr>
                            ...
                            <td><a href="editetudiant?id=<c:out value='${user.id}' />"><i class='bx bxs-edit' style='color:#39d119;font-size:20px;' title="Modifier l'etudiant"></i></a>
                                &nbsp;&nbsp;&nbsp;&nbsp; <a
                                href="deleteetudiant?id=<c:out value='${user.id}' />"><i class='bx bx-trash' style='color:#ea1818; font-size:20px;' title="Supprimer l'etudiant"></i></a></td>
