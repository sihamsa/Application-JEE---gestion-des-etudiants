...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark"> <a class="navbar-brand" href="#" data-abc="true">BBBOOTSTRAP</a> <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarColor02" aria-controls="navbarColor02" aria-expanded="false" aria-label="Toggle navigation"> <span class="navbar-toggler-icon"></span> </button>
        <div class="collapse navbar-collapse" id="navbarColor02">
            ...
            <form  action="chercherfilier" method="post" class="form-inline my-2 my-lg-0"> <input class="form-control mr-sm-2" type="text" placeholder="Search" name="nameUser2" value="${model2.nameUser2}"> <button class="btn btn-secondary my-2 my-sm-0" type="submit">Search</button> </form> 
    ...
    <a href="<%=request.getContextPath()%>/newfilier" > <i class='bx bx-plus' style='color:rgb(66, 64, 64);font-size:40px;' title="Ajouter un departement" ></i></a>
        ...
        <div class="" style="position:relative; top: 10%;">
            <table class="table">
                ...
                <tbody>
                       <c:forEach items="${model2.filiere}" var="p">
          ...
          <tr>
            ...
            <td>${p.netudiant }</td>
                  ...
                  <td>${existingUser.nom }</td>
                            <td><a href="editfilier?id=<c:out value='${user.id}' />"><i class='bx bxs-edit' style='color:#39d119;font-size:20px;' title="Modifier le filiere"></i></a>
                                &nbsp;&nbsp;&nbsp;&nbsp; <a
                                href="deletefilier?id=<c:out value='${user.id}' />"><i class='bx bx-trash' style='color:#ea1818; font-size:20px;' title="Supprimer le filiere"></i></a></td>
