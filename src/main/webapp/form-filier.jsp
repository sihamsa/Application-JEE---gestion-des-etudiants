...
<div   style="margin-top:5%;">
    ...
    <center><c:if test="${user != null}">
        <form action="updatefilier" method="post" class="start">
    </c:if>
    <c:if test="${user == null}">
        <form action="insertfilier" method="post" class="start">
    </c:if>
    
    <caption>
        <h2>
            <c:if test="${user != null}">
    Modifier le filiere <c:out value="${user.nom}" /> :	
    <br>
     </c:if>
            <c:if test="${user == null}">
           Ajouter un filiere :
    ...
    <div class="form-floating mb-3">
            <label for="floatingInput">Nom de filiere</label>
    
        <input type="text" style=" width:70% " class="form-control" name="name1"  value="<c:out value='${user.nom}' />" id="floatingInput" placeholder="Nom de filiere">
      </div>
      <div class="form-floating mb-3">
              <label for="floatingInput">Nom de professeur</label>
      
        <input type="text" style=" width:70% " class="form-control" name="name2"  value="<c:out value='${user.nomprof}' />" id="floatingInput" placeholder="Nom de professeur">
      </div>
        <div class="form-floating mb-3">
                <label for="floatingInput">Numbre des etudiants</label>
        
        <input type="number" style=" width:70% " class="form-control" name="name4"  value="<c:out value='${user.netudiant}' />" id="floatingInput" placeholder="Nom de professeur">
      </div>
      <c:if test="${user != null}">
      <div class="form-floating mb-3">
              <label for="floatingInput">Id de Departement</label>
      
        <input type="number" style=" width:70% " readonly class="form-control" name="name3"  value="<c:out value='${user.iddepar}' />" id="floatingInput" placeholder="Id de Departement">
      </div>
    </c:if>
    ...
    <c:if test="${user == null}">
     <div class="form-floating mb-3">
        ...
        <input type="number" style=" width:70% " class="form-control" name="name3"  id="floatingInput" placeholder="Id de Departement">
      </div>
    </c:if>
